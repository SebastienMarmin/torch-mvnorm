...
static const char __pyx_k_infin[] = "infin";
...
static const char __pyx_k_abseps[] = "abseps";
static const char __pyx_k_correl[] = "correl";
static const char __pyx_k_import[] = "__import__";
static const char __pyx_k_inform[] = "inform";
static const char __pyx_k_maxpts[] = "maxpts";
static const char __pyx_k_releps[] = "releps";
static const char __pyx_k_pygfunc[] = "pygfunc";
static const char __pyx_k_ValueError[] = "ValueError";
static const char __pyx_k_ImportError[] = "ImportError";
static const char __pyx_k_RuntimeError[] = "RuntimeError";
static const char __pyx_k_cline_in_traceback[] = "cline_in_traceback";
static const char __pyx_k_source_pygfunc_pyx[] = "source/pygfunc.pyx";
...
static PyObject *__pyx_n_s_abseps;
...
static PyObject *__pyx_n_s_maxpts;
...
static PyObject *__pyx_kp_s_source_pygfunc_pyx;
static PyObject *__pyx_n_s_test;
static PyObject *__pyx_kp_u_unknown_dtype_code_in_numpy_pxd;
static PyObject *__pyx_n_s_upper;
static PyObject *__pyx_n_s_value;
static PyObject *__pyx_n_s_zeros;
static PyObject *__pyx_pf_7pygfunc_f(CYTHON_UNUSED PyObject *__pyx_self, int __pyx_v_d, PyArrayObject *__pyx_v_lower, PyArrayObject *__pyx_v_upper, PyArrayObject *__pyx_v_infin, PyArrayObject *__pyx_v_correl, int __pyx_v_maxpts, double __pyx_v_abseps, double __pyx_v_releps, int __pyx_v_info); /* proto */
...
/* Python wrapper */
static PyObject *__pyx_pw_7pygfunc_1f(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyMethodDef __pyx_mdef_7pygfunc_1f = {"f", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_7pygfunc_1f, METH_VARARGS|METH_KEYWORDS, 0};
static PyObject *__pyx_pw_7pygfunc_1f(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  int __pyx_v_d;
  PyArrayObject *__pyx_v_lower = 0;
  PyArrayObject *__pyx_v_upper = 0;
  PyArrayObject *__pyx_v_infin = 0;
  PyArrayObject *__pyx_v_correl = 0;
  int __pyx_v_maxpts;
  double __pyx_v_abseps;
  double __pyx_v_releps;
  int __pyx_v_info;
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("f (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_d,&__pyx_n_s_lower,&__pyx_n_s_upper,&__pyx_n_s_infin,&__pyx_n_s_correl,&__pyx_n_s_maxpts,&__pyx_n_s_abseps,&__pyx_n_s_releps,&__pyx_n_s_info,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_lower)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("f", 1, 9, 9, 1); __PYX_ERR(0, 10, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_upper)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("f", 1, 9, 9, 2); __PYX_ERR(0, 10, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  3:
        if (likely((values[3] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_infin)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("f", 1, 9, 9, 3); __PYX_ERR(0, 10, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  4:
        if (likely((values[4] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_correl)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("f", 1, 9, 9, 4); __PYX_ERR(0, 10, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  5:
        if (likely((values[5] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_maxpts)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("f", 1, 9, 9, 5); __PYX_ERR(0, 10, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  6:
        if (likely((values[6] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_abseps)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("f", 1, 9, 9, 6); __PYX_ERR(0, 10, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  7:
        if (likely((values[7] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_releps)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("f", 1, 9, 9, 7); __PYX_ERR(0, 10, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  8:
        if (likely((values[8] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_info)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("f", 1, 9, 9, 8); __PYX_ERR(0, 10, __pyx_L3_error)
        }
      }
    ...
    __pyx_v_d = __Pyx_PyInt_As_int(values[0]); if (unlikely((__pyx_v_d == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 10, __pyx_L3_error)
    __pyx_v_lower = ((PyArrayObject *)values[1]);
    __pyx_v_upper = ((PyArrayObject *)values[2]);
    __pyx_v_infin = ((PyArrayObject *)values[3]);
    __pyx_v_correl = ((PyArrayObject *)values[4]);
    __pyx_v_maxpts = __Pyx_PyInt_As_int(values[5]); if (unlikely((__pyx_v_maxpts == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 10, __pyx_L3_error)
    __pyx_v_abseps = __pyx_PyFloat_AsDouble(values[6]); if (unlikely((__pyx_v_abseps == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 10, __pyx_L3_error)
    __pyx_v_releps = __pyx_PyFloat_AsDouble(values[7]); if (unlikely((__pyx_v_releps == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 10, __pyx_L3_error)
    __pyx_v_info = __Pyx_PyInt_As_int(values[8]); if (unlikely((__pyx_v_info == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 10, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("f", 1, 9, 9, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 10, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("pygfunc.f", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_lower), __pyx_ptype_5numpy_ndarray, 1, "lower", 0))) __PYX_ERR(0, 10, __pyx_L1_error)
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_upper), __pyx_ptype_5numpy_ndarray, 1, "upper", 0))) __PYX_ERR(0, 10, __pyx_L1_error)
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_infin), __pyx_ptype_5numpy_ndarray, 1, "infin", 0))) __PYX_ERR(0, 10, __pyx_L1_error)
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_correl), __pyx_ptype_5numpy_ndarray, 1, "correl", 0))) __PYX_ERR(0, 10, __pyx_L1_error)
  __pyx_r = __pyx_pf_7pygfunc_f(__pyx_self, __pyx_v_d, __pyx_v_lower, __pyx_v_upper, __pyx_v_infin, __pyx_v_correl, __pyx_v_maxpts, __pyx_v_abseps, __pyx_v_releps, __pyx_v_info);
...
static PyObject *__pyx_pf_7pygfunc_f(CYTHON_UNUSED PyObject *__pyx_self, int __pyx_v_d, PyArrayObject *__pyx_v_lower, PyArrayObject *__pyx_v_upper, PyArrayObject *__pyx_v_infin, PyArrayObject *__pyx_v_correl, int __pyx_v_maxpts, double __pyx_v_abseps, double __pyx_v_releps, int __pyx_v_info) {
  int __pyx_v_dd;
  PyArrayObject *__pyx_v_delta = 0;
  double __pyx_v_error;
  double __pyx_v_value;
  int __pyx_v_inform;
  __Pyx_LocalBuf_ND __pyx_pybuffernd_correl;
  __Pyx_Buffer __pyx_pybuffer_correl;
  __Pyx_LocalBuf_ND __pyx_pybuffernd_delta;
  __Pyx_Buffer __pyx_pybuffer_delta;
  __Pyx_LocalBuf_ND __pyx_pybuffernd_infin;
  __Pyx_Buffer __pyx_pybuffer_infin;
  ...
  __pyx_pybuffer_infin.pybuffer.buf = NULL;
  __pyx_pybuffer_infin.refcount = 0;
  __pyx_pybuffernd_infin.data = NULL;
  __pyx_pybuffernd_infin.rcbuffer = &__pyx_pybuffer_infin;
  __pyx_pybuffer_correl.pybuffer.buf = NULL;
  __pyx_pybuffer_correl.refcount = 0;
  __pyx_pybuffernd_correl.data = NULL;
  __pyx_pybuffernd_correl.rcbuffer = &__pyx_pybuffer_correl;
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_lower.rcbuffer->pybuffer, (PyObject*)__pyx_v_lower, &__Pyx_TypeInfo_double, PyBUF_FORMAT| PyBUF_STRIDES, 1, 0, __pyx_stack) == -1)) __PYX_ERR(0, 10, __pyx_L1_error)
  }
  __pyx_pybuffernd_lower.diminfo[0].strides = __pyx_pybuffernd_lower.rcbuffer->pybuffer.strides[0]; __pyx_pybuffernd_lower.diminfo[0].shape = __pyx_pybuffernd_lower.rcbuffer->pybuffer.shape[0];
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_upper.rcbuffer->pybuffer, (PyObject*)__pyx_v_upper, &__Pyx_TypeInfo_double, PyBUF_FORMAT| PyBUF_STRIDES, 1, 0, __pyx_stack) == -1)) __PYX_ERR(0, 10, __pyx_L1_error)
  }
  __pyx_pybuffernd_upper.diminfo[0].strides = __pyx_pybuffernd_upper.rcbuffer->pybuffer.strides[0]; __pyx_pybuffernd_upper.diminfo[0].shape = __pyx_pybuffernd_upper.rcbuffer->pybuffer.shape[0];
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_infin.rcbuffer->pybuffer, (PyObject*)__pyx_v_infin, &__Pyx_TypeInfo_int, PyBUF_FORMAT| PyBUF_STRIDES, 1, 0, __pyx_stack) == -1)) __PYX_ERR(0, 10, __pyx_L1_error)
  }
  __pyx_pybuffernd_infin.diminfo[0].strides = __pyx_pybuffernd_infin.rcbuffer->pybuffer.strides[0]; __pyx_pybuffernd_infin.diminfo[0].shape = __pyx_pybuffernd_infin.rcbuffer->pybuffer.shape[0];
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_correl.rcbuffer->pybuffer, (PyObject*)__pyx_v_correl, &__Pyx_TypeInfo_double, PyBUF_FORMAT| PyBUF_STRIDES, 1, 0, __pyx_stack) == -1)) __PYX_ERR(0, 10, __pyx_L1_error)
  }
  __pyx_pybuffernd_correl.diminfo[0].strides = __pyx_pybuffernd_correl.rcbuffer->pybuffer.strides[0]; __pyx_pybuffernd_correl.diminfo[0].shape = __pyx_pybuffernd_correl.rcbuffer->pybuffer.shape[0];
 ...
 *         double error  = 42
 */
  __pyx_v_dd = __Pyx_div_long((__pyx_v_d * (__pyx_v_d - 1)), 2);
 ...
 */
  ...
  __pyx_t_3 = __Pyx_PyInt_From_int(__pyx_v_d); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 13, __pyx_L1_error)
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_delta.rcbuffer->pybuffer, (PyObject*)__pyx_t_5, &__Pyx_TypeInfo_double, PyBUF_FORMAT| PyBUF_STRIDES, 1, 0, __pyx_stack) == -1)) {
      __pyx_v_delta = ((PyArrayObject *)Py_None); __Pyx_INCREF(Py_None); __pyx_pybuffernd_delta.rcbuffer->pybuffer.buf = NULL;
      __PYX_ERR(0, 13, __pyx_L1_error)
    } else {__pyx_pybuffernd_delta.diminfo[0].strides = __pyx_pybuffernd_delta.rcbuffer->pybuffer.strides[0]; __pyx_pybuffernd_delta.diminfo[0].shape = __pyx_pybuffernd_delta.rcbuffer->pybuffer.shape[0];
    }
  }
  __pyx_t_5 = 0;
 ...
 */
  ...
  { PyObject *__pyx_type, *__pyx_value, *__pyx_tb;
    ...
    __Pyx_SafeReleaseBuffer(&__pyx_pybuffernd_correl.rcbuffer->pybuffer);
    __Pyx_SafeReleaseBuffer(&__pyx_pybuffernd_delta.rcbuffer->pybuffer);
    __Pyx_SafeReleaseBuffer(&__pyx_pybuffernd_infin.rcbuffer->pybuffer);
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s_abseps, __pyx_k_abseps, sizeof(__pyx_k_abseps), 0, 0, 1, 1},
  ...
  {&__pyx_n_s_maxpts, __pyx_k_maxpts, sizeof(__pyx_k_maxpts), 0, 0, 1, 1},
  ...
  {&__pyx_kp_s_source_pygfunc_pyx, __pyx_k_source_pygfunc_pyx, sizeof(__pyx_k_source_pygfunc_pyx), 0, 0, 1, 0},
 ...
 *         int dd = d*(d-1)/2
 */
  __pyx_tuple__8 = PyTuple_Pack(14, __pyx_n_s_d, __pyx_n_s_lower, __pyx_n_s_upper, __pyx_n_s_infin, __pyx_n_s_correl, __pyx_n_s_maxpts, __pyx_n_s_abseps, __pyx_n_s_releps, __pyx_n_s_info, __pyx_n_s_dd, __pyx_n_s_delta, __pyx_n_s_error, __pyx_n_s_value, __pyx_n_s_inform); if (unlikely(!__pyx_tuple__8)) __PYX_ERR(0, 10, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__8);
  __Pyx_GIVEREF(__pyx_tuple__8);
  __pyx_codeobj__9 = (PyObject*)__Pyx_PyCode_New(9, 0, 14, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__8, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_source_pygfunc_pyx, __pyx_n_s_f, 10, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__9)) __PYX_ERR(0, 10, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
 ...
 */
  ...
  PyList_SET_ITEM(__pyx_t_1, 3, __pyx_n_s_empty);
  ...
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_1 = __Pyx_ImportFrom(__pyx_t_2, __pyx_n_s_ones); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 1, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_ones, __pyx_t_1) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
 ...
 *         int dd = d*(d-1)/2
 */
  __pyx_t_2 = PyCFunction_NewEx(&__pyx_mdef_7pygfunc_1f, NULL, __pyx_n_s_pygfunc); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 10, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
